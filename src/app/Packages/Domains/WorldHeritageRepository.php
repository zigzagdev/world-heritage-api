...
readonly class WorldHeritageRepository implements WorldHeritageRepositoryInterface
{
    ...
    public function insertHeritage(WorldHeritageEntity $entity): WorldHeritageEntity
    {
        $insertValue = [
            'id' => $entity->getId(),
        ...
        return new WorldHeritageEntity(
            ...
            statePartyCodes: $this->parseStateParty(implode(
                ',',
                $heritage->countries->pluck('state_party_code')->all(),
            )),
    ...
    public function updateOneHeritage(WorldHeritageEntity $entity): WorldHeritageEntity
    {
        ...
        return new WorldHeritageEntity(
            ...
            statePartyCodes: $this->parseStateParty(implode(',', $model->countries->pluck('state_party_code')->all())),
            statePartyMeta: $partyMeta,
        );
    }
